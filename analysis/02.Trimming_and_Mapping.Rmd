...
Mouse AAV-PGR bulk RNA-seq were performed using paired-end sequencing method and below are the scripts for trimming and mapping paired end sequencing read.
